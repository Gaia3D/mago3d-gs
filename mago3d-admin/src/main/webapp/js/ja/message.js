...
// Cache
JS_MESSAGE["cache.input.invalid"] = "必須入力値が有効ではありません。";

//ユーザー
JS_MESSAGE["user.id.empty"] = "ユーザ名を入力してください。";
JS_MESSAGE["user.id.min_length.invalid"] = "ユーザー名最小の長さが正しくありません。";
...
JS_MESSAGE["policy.menu.invalid"] = "必須入力値が有効ではありません。";
...
JS_MESSAGE["data.attribut.dir.invalid"]="The Data property directory path is incorrect.";
...
JS_MESSAGE["user.group.email.type"] = "電子メールの形式に合わせて入力してください。"
JS_MESSAGE["user.group.mobiler.type"] = "携帯電話番号の形式に合わせて入力してください。"
...
//widget
JS_MESSAGE["config.schedule.widget.does.not.exist"] = "スケジュール実行履歴が存在しません。";
JS_MESSAGE["config.widget.using"] = "使用中";
JS_MESSAGE["config.widget.stop.using"] = "無効";
JS_MESSAGE["config.widget.fail.count"] = "失敗回数";
JS_MESSAGE["config.widget.dormancy"] = "休眠";
JS_MESSAGE["config.widget.expires"] = "期間の満了";
JS_MESSAGE["config.temporary.password"] = "仮パスワード";
