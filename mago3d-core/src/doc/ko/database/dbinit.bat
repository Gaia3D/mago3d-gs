...
psql -U postgres -d mago3d-gs -a -f %CUR_PATH%ddl\api.sql
psql -U postgres -d mago3d-gs -a -f %CUR_PATH%ddl\board.sql
psql -U postgres -d mago3d-gs -a -f %CUR_PATH%ddl\common_code.sql
psql -U postgres -d mago3d-gs -a -f %CUR_PATH%ddl\dataInfo_attribute.sql
...
psql -U postgres -d mago3d-gs -a -f %CUR_PATH%ddl\issue.sql
...
psql -U postgres -d mago3d-gs -a -f %CUR_PATH%ddl\schedule.sql
:: psql -U postgres -d mago3d-gs -a -f %CUR_PATH%ddl\sso_log.sql
...
psql -U postgres -d mago3d-gs -a -f %CUR_PATH%index\api_log.sql
psql -U postgres -d mago3d-gs -a -f %CUR_PATH%index\data_info_log.sql
:: psql -U postgres -d mago3d-gs -a -f %CUR_PATH%index\sso_log.sql

psql -U postgres -d mago3d-gs -a -f %CUR_PATH%trigger\access_log_trigger.sql
psql -U postgres -d mago3d-gs -a -f %CUR_PATH%trigger\api_log_trigger.sql
psql -U postgres -d mago3d-gs -a -f %CUR_PATH%trigger\data_info_log_trigger.sql
:: psql -U postgres -d mago3d-gs -a -f %CUR_PATH%trigger\sso_log_trigger.sql

psql -U postgres -d mago3d-gs -a -f %CUR_PATH%dml\insert2.sql
